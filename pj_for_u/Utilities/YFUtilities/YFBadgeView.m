...
// 滕佳明 15/8/13 改了height margin radius YFBadgeViewAlignmentTopRight 三个值，以下都有注释
#import "YFBadgeView.h"

//改变了以下三个值，原值 16 8 10
static const CGFloat YFBadgeViewHeight = 11.0f;
static const CGFloat YFBadgeViewTextSideMargin = 4.f;
static const CGFloat YFBadgeViewCornerRadius = 5.0f;
...
- (void)layoutSubviews
{
    ...
    switch (self.badgeAlignment) {
        case YFBadgeViewAlignmentTopRight:      // x减了5，y加了5
